<!-- DMK Media Modal : Popup Promosi & Portofolio -->
    ...
    <x-material-modal id="modal-enamel" title="Kubah Masjid Enamel" image="enamel.png"
        ...
        description="Kubah berbahan dasar plat steel low carbon khusus standar enamel, dilapisi porselen enamel coating dari PT. Maspion dengan pemanasan oven bersuhu tinggi (± 800°C). Menghasilkan permukaan porselen yang sangat keras, mengkilap mewah, tahan gores, dan warna tidak akan pudar selama puluhan tahun."
        :specs="[
            'Ketebalan Plat' => '1.0 - 1.2 mm (Steel Low Carbon)',
            'Finishing' => 'Enamel Coating PT. Maspion',
            'Ketahanan Warna' => 'Garansi Resmi > 20 Tahun',
            'Suhu Pembakaran' => '± 800°C (Anti Retak & Lepas)'
        ]"
        :benefits="[
